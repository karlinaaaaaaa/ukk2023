...
<div class="container mt-3">
        ...
        <div class="card my-5"  style="background-color:white">
            ...
            <h2 class="mb-3 mt-4 text-center" style="color:rgb(61, 61, 61);">D A F T A R</h2>
              ...
              <div class="mb-3 mt-3 text-center">
                nama : <br>
                <input class="rounded-3 border-light" type="text" name="nama_lengkap" 
                placeholder="masukan nama anda" requtred style="width: 300px;">
              </div>
              <div class="mb-3 mt-3 text-center">
                username : <br>
              ...
              <div class="mb-3 mt-3 text-center">
                ...
                placeholder="masukan password anda" requtred style="width: 300px;">
              </div>
              <div class="mb-3 mt-3 text-center">
                telpn: <br>
                <input class="rounded-3 border-light" type="text" name="tlpn" 
                placeholder="masukan tlpn anda" requtred style="width: 300px;">
              </div>
              <div class="text-center mt-3"> 
                <button type="submit" class="btn px-3 mb-3 " style="width: 200px;background:#B4CDE6">Daftar</button> <br>
                <p><i>Belum Punya Akun? Click <a href="from login.php" class="text-primary">login</a></i></p>
                </div>
        </form>
</body>
</html>